              ...
              <div className="foot_subs">
                ...
                <form onSubmit={handleSubmit} className="foot_form">
                  ...
                  <p>
                    ...
                    <Link to="/terms/conditions" className="foot_subs_text" onClick={handleFooterLinkClick}>
                      Terms & Conditions
                    </Link>
                  </p>
            ...
            <div className="sub_footer_wrapper">
              <div className="foot_policyLink">
                <ul>
                  <li className="subfoot_link_text1">
                    <Link to="/policy/privacy" onClick={handleFooterLinkClick}>
                      <p className="foot_policyLink_p">Privacy Policy</p>
                    </Link>
                  </li>
                  <li className="subfoot_link_text2">
                    <Link to="/terms/conditions" onClick={handleFooterLinkClick}>
                      <p className="foot_policyLink_p">TERMS & CONDITIONS</p>
                    </Link>
                  </li>
                  <li className="subfoot_link_text3">
                    <Link to="/policy/Terms" onClick={handleFooterLinkClick}>
              ...
              <div className="foot_copyright">
                <p>
                  ...
                  <span>
                    <a href="https://suraj-ccc9e.web.app/"> | Built by Suraj Shaw</a>
                  </span>
                </p>
              </div>
            </div>
